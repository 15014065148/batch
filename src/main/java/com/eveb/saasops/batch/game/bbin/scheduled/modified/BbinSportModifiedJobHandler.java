...
@Slf4j
@Service
@JobHander(value = "bbinSportModifiedJobHandler")
public class BbinSportModifiedJobHandler extends IBbinJobHandler {
    ...
    public List<BBINRequestParameter> prepareParameter(int[] range,Object[] params)
    {
        ...
        parameter.setIndexName(ElasticSearchConstant.BBIN_INDEX_SPORT_MDF);
        parameter.setTypeName(ElasticSearchConstant.BBIN_TYPE_SPORT_MDF);
        parameter.setMethod(MethodEnum.Enum_Sport_Mdf.getValue());
        list.add(parameter);
        return list;
    }
}
