...
public class TripleDES {
     ...
     */
    public static String decrypt(String base64edData, String base64edKey, String base64edIv) throws GeneralSecurityException {
     ...
     * @throws UnsupportedEncodingException
     */
    public static String encrypt(String data, String base64edKey, String base64edIv) throws GeneralSecurityException {
        byte[] keyByte = Base64.decodeBase64(base64edKey);
