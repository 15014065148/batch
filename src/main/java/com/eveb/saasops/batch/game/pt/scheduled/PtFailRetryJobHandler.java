...
@Slf4j
@Service
@JobHander(value = "ptFailRetryJobHandler")
public class PtFailRetryJobHandler extends IPtJobHandler {
    ...
    public ReturnT<String> execute(String... strings) throws Exception {
        ...
        List<JobFailMessageModel> faillist = sysService.getExecuteFailMessages(PlatFromEnum.Enum_PT.getValue(),jobID,limit);
