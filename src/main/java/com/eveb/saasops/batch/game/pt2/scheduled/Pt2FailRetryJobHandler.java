...
@Slf4j
@Service
@JobHander(value = "pt2FailRetryJobHandler")
public class Pt2FailRetryJobHandler extends IPt2JobHandler {
    ...
    public ReturnT<String> execute(String... strings) throws Exception {
        ...
        List<JobFailMessageModel> faillist = sysService.getExecuteFailMessages(PlatFromEnum.Enum_PT2.getValue(),jobID,limit);
