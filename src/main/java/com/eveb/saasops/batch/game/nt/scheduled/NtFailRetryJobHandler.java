...
@Slf4j
@Service
@JobHander(value = "ntFailRetryJobHandler")
public class NtFailRetryJobHandler extends INtJobHandler {
    ...
    public ReturnT<String> execute(String... strings) throws Exception {
        ...
        List<JobFailMessageModel> faillist = sysService.getExecuteFailMessages(PlatFromEnum.Enum_NT.getValue(),jobID,limit);
