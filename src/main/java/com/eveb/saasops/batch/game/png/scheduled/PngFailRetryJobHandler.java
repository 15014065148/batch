...
@Slf4j
@Service
@JobHander(value = "pngFailRetryJobHandler")
public class PngFailRetryJobHandler extends IPngJobHandler {
    ...
    public ReturnT<String> execute(String... strings) throws Exception {
        ...
        List<JobFailMessageModel> faillist = sysService.getExecuteFailMessages(PlatFromEnum.Enum_PNG.getValue(),jobID,limit);
