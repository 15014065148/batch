...
@Slf4j
@Service
@JobHander(value = "aginYoplayModifiedJobHandler")
public class AginYoplayModifiedJobHandler extends IAginJobHandler {

    @Override
    public AginRequestParameterModel prepareParameter() {
        AginRequestParameterModel parameter = new AginRequestParameterModel();
        parameter.setRemotePath("/YOPLAY/lostAndfound/");
