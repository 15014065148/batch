...
@Slf4j
@Service
@JobHander(value = "ibcFailRetryJobHandler")
public class IbcFailRetryJobHandler extends IibcJobHandler {
    ...
    public ReturnT<String> execute(String... strings) throws Exception {
        ...
        List<JobFailMessageModel> faillist = sysService.getExecuteFailMessages(PlatFromEnum.Enum_IBC.getValue(),jobID,limit);
